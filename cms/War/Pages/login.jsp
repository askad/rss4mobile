...
<%
    ...
    lang = (null == lang ? Commons.ENG : lang);
%>
...
<div class="loginplan_bg">
    <div class="loginplan">
        <div class="loginname">Welcome to the CMS</div>
        ...
        <div style="height: 25px;">
         ...
         <div style="padding: 12px 0pt 0pt 180px; clear: both; height: 27px ! important;">
            <input type="submit" tabindex="4" name="btlogin" id="btlogin" value="Login" style="font-family: Verdana; font-style: normal; font-variant: normal; font-weight: bold; font-size: 12px; line-height: normal; font-size-adjust: none; font-stretch: normal; -x-system-font: none; padding-top: 2px ! important;"/>
         </div>
    </div>
</div>
</div>
