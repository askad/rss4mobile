...
public class TestService extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // List<EntityGroup> entityGroupList = (List<EntityGroup>) pm
        // .newQuery(EntityGroup.class).execute();
        // pm.deletePersistentAll(entityGroupList);
        // List<EntitySite> entitySiteList = (List<EntitySite>) pm.newQuery(
        // EntitySite.class).execute();
        ...
        //
        // EntitySite entitySite2 = new EntitySite();
        ...
        while (brd.read(s) != -1) {
            ...
            resp.getWriter().write(new String((new String(s)).getBytes(),"UTF-8"));
            resp.getWriter().flush();
        }
        // DataOutputStream out = new
        // DataOutputStream(connection.getOutputStream());
        // String content = "mobile=" + mobile + "&uuid=" + uuid + "&password="
        // + password + "&friend="
...
http://blog.sina.cn/prog/wapsite/blog/ComPub.php?oid=sina&uid=1191258123&nid=4701280b0100ixd0&title=%E9%9F%A9%E5%AF%92&atitle=2010%E5%B9%B405%E6%9C%8827%E6%97%A5&sumcom=8798&cflag=1

http://3g.sina.com.cn/prog/wapsite/blog/ComPub.php?oid=sina&uid=1747443761&nid=6827e0310100ii8y&title=oyyo%E7%9A%84%E5%8D%9A%E5%AE%A2&atitle=%E6%AC%A2%E8%BF%8E%E6%82%A8%E5%9C%A8%E6%96%B0%E6%B5%AA%E5%8D%9A%E5%AE%A2%E5%AE%89%E5%AE%B6&sumcom=2&cflag=1&gsid=3_58a251a38397e717d2d456c5893220105a&PHPSESSID=d70ba09f23b274527f0fd8ae7c7cc453
*/